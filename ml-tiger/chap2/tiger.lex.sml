...
fun yyAction42 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; commentLen := 1; continue()))
fun yyAction43 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; stringCon := ""; stringPos := yypos; continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction44(strm, yyNO_MATCH)
                      else yyQ49(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction44(strm, yyNO_MATCH)
                  else yyQ49(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"e"
...
fun yyQ26 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ95(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
...
fun yyQ9 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ10(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
